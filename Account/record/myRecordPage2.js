$(function(){
    ...
    $('#playPause').click(function(){
        ...
        if(audio.paused){
            audio.play();
            rotate();
            $('.icon-btn').removeClass('icon-bofang1').addClass('icon-zanting1')
        } else{
            audio.pause();

            $('.icon-btn').removeClass('icon-zanting1').addClass('icon-bofang1')
        }
    });
...
function audioEnded() {
    ...
    audio.currentTime=0;
    audio.pause();
    $('.play-pause>span').removeClass('icon-zanting1').addClass('icon-bofang1');
}
